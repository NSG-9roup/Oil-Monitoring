  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col font-sans text-slate-800">
      ...
      {activeLightboxImage && (
        <Portal>
          <div 
            className="fixed inset-0 z-[120] flex flex-col items-center justify-center bg-black/35 backdrop-blur-sm p-4 animate-fade-fast"
          ...
          >
            ...
            <p className="text-white/80 text-xs font-semibold mt-4 tracking-wide text-center">Ketuk di mana saja untuk menutup</p>
          </div>
        </Portal>
      )}
    </div>
