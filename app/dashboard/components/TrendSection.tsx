...
function ChartSkeleton() {
  return (
    <div className="h-[200px] sm:h-[250px] lg:h-[300px] w-full rounded-2xl bg-slate-50/80 animate-pulse flex flex-col justify-between p-6">
      ...
      <div className="flex items-end gap-3 h-36 w-full pt-4">
        <div className="flex-1 bg-slate-200/80 h-1/3 rounded-t-lg"></div>
        <div className="flex-1 bg-slate-200/80 h-1/2 rounded-t-lg"></div>
        <div className="flex-1 bg-slate-200/80 h-2/3 rounded-t-lg"></div>
        <div className="flex-1 bg-slate-200/80 h-1/2 rounded-t-lg"></div>
        <div className="flex-1 bg-slate-200/80 h-3/4 rounded-t-lg"></div>
        <div className="flex-1 bg-slate-200/80 h-5/6 rounded-t-lg"></div>
      </div>
...
function EmptyChartCard({
  ...
  actionText: string
  onAction: () => void
  colorScheme?: 'orange' | 'indigo' | 'sky' | 'rose'
}) {
  const iconColors = {
  ...
  return (
    <div className="flex flex-col items-center justify-center p-8 bg-slate-50/60 rounded-3xl border border-dashed border-slate-200 text-center min-h-[260px]">
      <div className={`w-14 h-14 rounded-2xl ${iconColors[colorScheme]} flex items-center justify-center mb-3 shadow-sm`}>
      ...
      <button
        type="button"
        onClick={onAction}
        className={`px-5 py-2.5 rounded-xl ${btnColors[colorScheme]} text-white text-xs font-black uppercase tracking-widest shadow-md transition-all active:scale-95 flex items-center gap-1.5`}
      >
