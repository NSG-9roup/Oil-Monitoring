                        ...
                        <td className="px-6 py-4 text-right">
                          {report.pdf_path ? (
                            <button
                              ...
                              className="text-xs font-bold text-blue-600 hover:bg-blue-50 px-3 py-1.5 rounded-lg border border-blue-200 transition-colors inline-flex items-center gap-1.5"
                              title={language === 'id' ? 'Lihat Laporan PDF' : 'View PDF Report'}
                            >
                            ...
                            <span className="text-xs font-semibold text-slate-300 italic select-none">
